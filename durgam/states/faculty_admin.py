"""FacultyAdminListState — read-only admin faculty directory (M10 Phase P6).

Gated by faculty:read:* via _config_guard. Server-side search + filter +
pagination. NO PII fields (PAN/Aadhaar deferred to P5 / TD-084).
"""
...
class FacultyAdminListState(BaseState):
    loading: bool = True
    rows: list[dict] = []
    total: int = 0
