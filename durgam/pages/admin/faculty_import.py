...
def _preview_header() -> rx.Component:
    return rx.hstack(
        ...
        rx.text("Employee ID", width="160px", font_size="0.75rem", font_weight="600",
                color="var(--color-muted)"),
        rx.text("Username", width="160px", font_size="0.75rem", font_weight="600",
                color="var(--color-muted)"),
        rx.text("Name", width="180px", font_size="0.75rem", font_weight="600",
                color="var(--color-muted)"),
        rx.text("Status", font_size="0.75rem", font_weight="600",
        ...
        rx.box(
            rx.hstack(
                rx.link("← Admin", href="/admin", color="var(--color-primary)",
                        font_size="0.875rem"),
                rx.link("/ Faculty", href="/admin/faculty", color="var(--color-primary)",
                        font_size="0.875rem"),
                rx.heading("/ Faculty Import", size="5", font_family="var(--font-sans)"),
                gap="0.5rem", align="center", margin_bottom="1.5rem",
            ),
            # Template download
            rx.hstack(
