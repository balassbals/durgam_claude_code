    ...
    return rx.cond(
        ...
        rx.box(
            ...
            rx.vstack(
                ...
                rx.vstack(
                    rx.text("Dean Role Code", font_size="0.85rem", color="var(--color-muted)"),
                    rx.input(
                ...
                rx.hstack(
                    primary_btn("Save", on_click=SchoolConfigState.save_school),
            ...
            rx.box(
                ...
                data_table(
                    ...
                    columns=[
                        ...
                        TableColumn(key="dean_role_code", label="Dean Role", hidden_on_card=True),
                    ],
