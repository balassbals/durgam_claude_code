...
## Current milestone
**M10.5 Phase 2a in progress (app shell + grouped sidebar, proven on 5 pages).** M10 CLOSED (tag m10-close). Phase 1 shipped `89b7a0d`. M10.5 scope, phase table, and Q-decisions: `docs/milestones/M10.5.md`. Branch `m10-5-ui`, forked from `main` at `2eb8b0b`.
