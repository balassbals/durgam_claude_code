...
## Current milestone
**M10.5 Phase 1 shipped (`89b7a0d`); Phase 2 next (navigation restructure).** M10 CLOSED (tag m10-close). M10.5 scope, phase table, and Q-decisions: `docs/milestones/M10.5.md`. Branch `m10-5-ui`, forked from `main` at `2eb8b0b`.
