...
**Current milestone**: M10 (Faculty Module) — in progress. M9 closed 2026-06-14, merged as 2d819c4, tag m9-close. M10 branch: m10-faculty. Phase P1 shipped (`27d323a`) + P1.1 fix (`f2b671b`) + P2 photo upload (`d3ba34d`) + P2.1 (`2aba531`) + P2.2 (`637b7bb`) + P2.3 photo URL fix (`b9ba64f`) + P3a education CRUD (`23dcdaf`) + P3a.1 dialog close fix (`b99fdfe`) + P3a.2 Add/Edit modal close fix (`9613993`) + P3b/P3c experience+expertise CRUD (`d1468cb`) + P4 documents PDF upload (`5ec8b65`) + P4.1 compile fix (`ee54424`) + P6 admin faculty directory (`ad703f8`) + P6.1 fix (`7ca3701`) + Phase 6 FDP quick-access nav (`5f4b1e9`) + Phase 8A faculty directory+detail (`5abedb3`) + 8A.1 grid fix (`e795979`) + Phase 8B faculty requests overlay (`018773d`) + Phase 9A NRF contract-term expansion (`adfb662`) + 9A.1 renew-wiring fix (pending commit); Phase P5 deferred pending TD-084; TD-038 + TD-039 + TD-085 deferred; Phase 10 next.
