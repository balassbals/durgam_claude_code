...
**Current milestone**: M8.1 closed. Merged to main as <SHA-pending> on <date-pending>; tag: m8.1-close. M8.1 covered E-016 (legacy balance import), E-017 (withdraw approved leave), E-022 (admin balance/request edit), TD-036 (CL annual credit), TD-037 (notification enqueue silent no-op). The next milestone has not been selected yet; candidates listed in docs/milestones/.
...
## Current milestone
**M8.1 closed. Merged to main as <SHA-pending> on <date-pending>; tag: m8.1-close.**
