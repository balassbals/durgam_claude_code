"""noc_faculty_id_backfill

M10 Phase 11B (Q-P11.4 / D-020) — backfill faculty_id on non_owned_courses.
...
Revision ID: f5c1d2e9a306
Revises: e4b0c1d8a295
...
revision: str = "f5c1d2e9a306"
down_revision: Union[str, Sequence[str], None] = "e4b0c1d8a295"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_TBL = "non_owned_courses"


def upgrade() -> None:
    op.add_column(_TBL, sa.Column("faculty_id", sa.Uuid(), nullable=True))
    op.create_index("ix_noc_faculty_id", _TBL, ["faculty_id"])
    op.create_foreign_key(
        "fk_noc_faculty_id", _TBL, "faculties", ["faculty_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint("fk_noc_faculty_id", _TBL, type_="foreignkey")
    op.drop_index("ix_noc_faculty_id", table_name=_TBL)
