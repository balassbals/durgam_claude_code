...
class TestSeed:
    def test_first_run_inserts_expected_rows(self, db_session):
        ...
        # M10 Phase 11D: 142 triples (145 prior − 3: class_coordinator_assignment
        # read/write/delete removed with the table per Q-P11D.1).
        assert _count(db_session, Permission) == 142, "Expected 142 seeded permission triples at M10 Phase 11D (145 prior − 3 class_coordinator)"
